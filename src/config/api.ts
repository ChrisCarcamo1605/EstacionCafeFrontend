...
export const BACKEND_API_URL = isServer 
  ? (process.env.SERVER_BACKEND_API_URL || import.meta.env.SERVER_BACKEND_API_URL || 'http://localhost:3484/api')
  : (import.meta.env.PUBLIC_BACKEND_API_URL || 'http://localhost:3484/api');

// URL del servicio ML
export const ML_API_URL = isServer
  ? (process.env.SERVER_ML_API_URL || import.meta.env.SERVER_ML_API_URL || 'http://localhost:8000/api')
...
export const EMAIL_SERVICE_URL = isServer
  ? (process.env.SERVER_EMAIL_SERVICE_URL || import.meta.env.SERVER_EMAIL_SERVICE_URL || 'http://localhost:3004/api/send-report')
